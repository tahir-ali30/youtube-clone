        ...
        <header className="flex justify-between gap-10 py-2.5 px-5 w-full items-center">
            ...
            <form className="md:flex hidden flex-grow gap-2 items-center justify-center">
                <div className="flex flex-grow max-w-[600px]">
                    <input type="text" placeholder="Search" className="w-full px-3 rounded-l-full border border-slate-400" />
            ...
            <div className="flex flex-shrink gap-3 items-center">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" height="24" fill="currentColor" viewBox="0 0 24 24" width="24" focusable="false">
